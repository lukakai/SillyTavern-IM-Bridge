...
export const BOT_COMMANDS: BotCommand[] = [
  ...
  { command: "api", description: "切换酒馆全局连接配置" },
  { command: "preset", description: "切换酒馆全局预设及内部选项" },
  { command: "model", description: "切换酒馆全局模型" },
  { command: "settingsundo", description: "撤销上次酒馆全局设置修改" },
